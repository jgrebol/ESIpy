...
$I_{\text{ring}}(\mathscr{A}) = 2^{n}\sum_{i_1,i_2...i_n} S_{i_1i_2}^{\text{A$_1$}}S_{i_2i_3}^{\text{A$_2$}} \cdot \cdot \cdot S_{i_ni_1}^{\text{A$_n$}}.$
...
$$\text{MCI}(\mathcal{A}) = \frac{1}{2n} \sum_{\mathcal{P}(\mathcal{A})}\text{I&#95;\text{ring}}(\mathcal{A}).$$
