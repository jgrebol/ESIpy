...
$$\text{I\textsubscript{ring}}(\mathscr{A}) = 2^{n} \sum_{i_1,i_2\ldots i_n} S_{i_1i_2}^{\text{A\textsubscript{1}}}S_{i_2i_3}^{\text{A\textsubscript{2}}} \cdot \cdot \cdot S_{i_ni_1}^{\text{A\textsubscript{n}}}$$
