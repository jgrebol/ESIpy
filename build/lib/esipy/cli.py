...
def main():
    ...
    if inp.iaomix is not None:
        extra_kwargs['iaomix'] = inp.iaomix
    ...
    for partition in partitions:
        if inp.mode == 'readaoms':
            ...
            if shortpart == "qtaim": # From AIMAll it is the name and the _atomicfiles. For ESIpy we include the partition
