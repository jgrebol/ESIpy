...
import numpy as np
from esipy.tools import save_file, format_partition, get_natorbs_from_ao, get_natorbs_from_mo, build_eta
...
def make_aoms(mol, mf, partition, myhf=None, save=None):
    ...
    # RESTRICTED
        ...
        if "CAS" in mf.__class__.__name__ or "FCI" in mf.__class__.__name__:
